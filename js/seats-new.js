...
var margin = {top: 20, right: 50, bottom: 10, left: 50},
    width = document.getElementById('seats-new').offsetWidth - margin.left - margin.right,
...
svg = d3.select("#seats-new").append("svg")
...
function createRects(data){
  ...
  data.forEach(function(d) {
    var x0 = 0;
    d.seats = color.domain().map(function(name) { return {name: name, x0: x0, x1: x0 += +d[name]}; });
